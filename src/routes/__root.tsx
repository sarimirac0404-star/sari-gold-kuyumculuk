...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sarı Gold Kuyumculuk, Eleşkirt / Ağrı'da 22 ayar ve 14 ayar altın takı, canlı altın fiyatları ve özenli kuyumculuk hizmeti sunuyor. Cumhuriyet Cd., 04600 Eleşkirt/Ağrı." },
      ...
      { property: "og:description", content: "Sarı Gold Kuyumculuk, Eleşkirt / Ağrı'da 22 ayar ve 14 ayar altın takı, canlı altın fiyatları ve özenli kuyumculuk hizmeti sunuyor. Cumhuriyet Cd., 04600 Eleşkirt/Ağrı." },
      { name: "twitter:description", content: "Sarı Gold Kuyumculuk, Eleşkirt / Ağrı'da 22 ayar ve 14 ayar altın takı, canlı altın fiyatları ve özenli kuyumculuk hizmeti sunuyor. Cumhuriyet Cd., 04600 Eleşkirt/Ağrı." },
